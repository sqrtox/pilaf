...
export const or = <Vs extends Validators>(
  ...vs: Vs
): Validator<InferAsUnion<Vs>> =>
  ((value) => vs.some((v) => v(value))) as ReturnType<typeof or>;

export const and = <Vs extends Validators>(
  ...vs: Vs
): Validator<InferAsIntersection<Vs>> =>
  ((value) => vs.every((v) => v(value))) as ReturnType<typeof and>;
